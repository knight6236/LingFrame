...
LingLong allows you to pause at any stage.
...
LingFrame (LingLong) is a **JVM runtime governance framework for long-running systems**.  
...
Thus, LingLong was born.

---

## What LingLong Focuses On Isn't "Adding Features"
...
LingLong addresses one core problem:
...
LingLong's purpose is to provide possibilities for **"retraction" and "reorganization"** when the system reaches a certain complexity.
...
LingLong doesn't hide complexity—  
...
LingLong won't make decisions for the system.
